...
(default,"Jordan 1 Retro High", "jordan1Retro.jpeg","Jordan Brand agregó materiales de lujo a una silueta clásica con el lanzamiento de las Jordan 1 Retro High Satin Snake Chicago (W). Esta versión combina el concepto actual Satin 1 de Jumpman con la combinación de colores que lo inició todo.", "2019/10/05", 3),
...
(default,"Nike blazer mid off", "nikeBlazer.jpeg","Las Nike Blazer Mid recuperan el look clásico de las zapatillas de baloncesto Nike. Los elegantes detalles de ante, el diseño Swoosh retro y la zona del tobillo acolchada crean un básico actual, al tiempo que la parte superior impecable ofrece un look ideal para cualquier conjunto.", "2020/12/01", 3),
(default,"New Balance 550", "newbalance550.jpeg","Estas zapatillas fueron lanzadas en noviembre de 2018 con un precio de $269 usd y al por menor por $170 usd.", "2019/01/12", 6),
(default,"Nike Air Force 1 Low", "nikeAirForce1.jpeg","Estas zapatillas fueron lanzadas en agosto de 2020 con un precio de $269 usd y al por menor por $170 usd.", "2021/01/01", 5),
